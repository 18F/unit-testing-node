...
** Docker users**: _The short way_
1. Run `./docker-startup.sh` to build and run the docker image and open your web browser to appropriate web address.
  - You may have to refresh after the server finally starts
